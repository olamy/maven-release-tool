...
public class VerifySiteStep extends AbstractStep {

    public VerifySiteStep(CommandRunner runner) {
        super(runner);
    }
    ...
    public String describe() {
        return "Verify site compilation with mvn -Preporting site site:stage";
    }

    @Override
    public List<String> defaultCommands(ReleaseState state) {
        return List.of("mvn -Preporting site site:stage");
    }
