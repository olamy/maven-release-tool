...
public class DeploySiteStep extends AbstractStep {

    public DeploySiteStep(CommandRunner runner) {
        super(runner);
    }
    ...
    public String describe() {
        return "Deploy component website (deploySite.sh or mvn site-deploy)";
    }
